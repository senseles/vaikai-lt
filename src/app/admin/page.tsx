    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Link
          ...
          className="px-4 py-2.5 text-sm bg-orange-600 text-white rounded-lg hover:bg-orange-700 font-medium transition-colors inline-flex items-center gap-2 min-h-[44px]"
        >
          <span>✉</span> Pasiūlymai
        </Link>
        <Link
          href="/admin/forumas"
