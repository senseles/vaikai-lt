export default function CityLoading() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 animate-pulse">
      {/* Breadcrumb skeleton */}
      <div className="h-4 w-40 bg-gray-200 dark:bg-slate-700 rounded mb-6" />

      {/* Title skeleton */}
      <div className="h-8 w-48 bg-gray-200 dark:bg-slate-700 rounded mb-2" />
      <div className="h-5 w-72 bg-gray-200 dark:bg-slate-700 rounded mb-6" />

      {/* Category tabs skeleton */}
      <div className="flex gap-2 mb-6">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="h-10 w-28 bg-gray-200 dark:bg-slate-700 rounded-lg" />
        ))}
      </div>
