      ...
      <section className="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 mt-6">
            ...
            <Link
              href="/forumas/naujas"
              className="inline-flex items-center gap-2 bg-[#2d6a4f] hover:bg-[#40916c] text-white font-semibold px-5 py-2.5 rounded-xl transition-colors text-sm"
            >
            ...
            {posts.map((post) => {
              ...
              return (
                <Link
                  ...
                  className="flex items-start gap-4 p-4 bg-white dark:bg-slate-800 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-gray-100 dark:border-slate-700 group"
                >
                  {/* Vote count */}
          ...
          <div className="flex items-center justify-center gap-2 mt-8">
            {page > 1 && (
              <Link
                ...
                className="px-4 py-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors"
              >
                Ankstesnis
              </Link>
            )}
